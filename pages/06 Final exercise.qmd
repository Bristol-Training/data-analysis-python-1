...
<img style="float:right; border-radius: 10px;" src="../assets/titanic.jpg"/>For the final exercise you should try to combine together all the skills you've learned over this course. This is expected to take you longer than any of the exercises so far. If you get to this point in the session, feel free to get started on it now, otherwise you can treat this as practice later on.

Read the file [`https://milliams.com/courses/data_analysis_python/titanic.csv`](https://milliams.com/courses/data_analysis_python/titanic.csv). This file contains information about all the passengers and crew aboard the RMS Titanic. Its columns are:
...
There's some help with the answers to some parts of this exercise [here](../answers/answer_final_exercise.qmd).
