...
For setup, go to our [setup instructions](https://bristol-training.github.io/data-science-project-setup/).

This course will use a tool called *Jupyter Notebooks* to run your Python code. 
