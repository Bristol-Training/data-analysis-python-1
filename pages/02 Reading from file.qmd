...
However, in this course we will read the files from a local folder `data`. You can do the same downloading all the data that is available in a zip file [data.zip](https://bristol-training.github.io/introduction-to-data-analysis-in-python/data/data.zip) and extract it in your working directory.
