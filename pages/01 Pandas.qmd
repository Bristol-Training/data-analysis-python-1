...
<div class="contents-grid">
    <div class="grid-icon"><img src="../assets/pipeline1.svg" width="100%"></div>
    <div class="grid-text">
        <p>
    ...
    <div class="grid-arrow"><img src="../assets/down_arrow.svg" width="100%"></div>
    <div class="grid-text"></div>
    <div class="grid-item"><img src="../assets/pipeline2.svg" width="100%"></div>
    <div class="grid-text">
    ...
    <div class="grid-arrow"><img src="../assets/down_arrow.svg" width="100%"></div>
    <div class="grid-text"></div>
    <div class="grid-icon"><img src="../assets/pipeline3.svg" width="100%"></div>
    <div class="grid-text">
        <p>
